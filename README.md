...
```
yarn add @gascomit/jetpack
```

Use the edge version (no guarantee of stability, but latest fixes + features)
```
yarn add github:gascomit/jetpack
```
...
``` ts
import makeWASocket, { makeInMemoryStore } from '@gascomit/jetpack'
...
const templateButtons = [
    {index: 1, urlButton: {displayText: '⭐ Star Jetpack on GitHub!', url: 'https://github.com/gascomit/jetpack'}},
    {index: 2, callButton: {displayText: 'Call me!', phoneNumber: '+2547-1824-1545'}},
...
import { downloadContentFromMessage } from '@gascomit/jetpack'
